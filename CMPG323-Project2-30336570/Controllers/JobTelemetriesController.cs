...
using CMPG323_Project2_30336570.Models;

namespace CMPG323_Project2_30336570.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class JobTelemetriesController : ControllerBase
    {
        private readonly NwutechDbContext _context;

        public JobTelemetriesController(NwutechDbContext context)
        {
            _context = context;
        }
